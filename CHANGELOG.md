...
#### :house: Internal
* `ember-tui`
  * [#117](https://github.com/patricklx/ember-tui/pull/117) pass __attrs__ to terminal-box node ([@patricklx](https://github.com/patricklx))
...
#### :rocket: Enhancement
* `ember-tui`
  * [#101](https://github.com/patricklx/ember-tui/pull/101) improve key handling ([@patricklx](https://github.com/patricklx))

#### :bug: Bug Fix
* `ember-tui`
  * [#99](https://github.com/patricklx/ember-tui/pull/99) try free node ([@patricklx](https://github.com/patricklx))
...
* ember-tui 1.0.6 (patch)

#### :bug: Bug Fix
* `ember-tui`
  * [#97](https://github.com/patricklx/ember-tui/pull/97) fix color bug again ([@patricklx](https://github.com/patricklx))
...
#### :bug: Bug Fix
* `ember-tui`
  * [#92](https://github.com/patricklx/ember-tui/pull/92) fix: handle non-contiguous color segments by resetting before each segment ([@patricklx](https://github.com/patricklx))
...
#### :bug: Bug Fix
* `ember-tui`
  * [#82](https://github.com/patricklx/ember-tui/pull/82) fix memory leak ([@patricklx](https://github.com/patricklx))
...
* `ember-tui`
  * [#75](https://github.com/patricklx/ember-tui/pull/75) refactoring to vite dev server ([@patricklx](https://github.com/patricklx))
...
#### :rocket: Enhancement
* `ember-tui`
  * [#56](https://github.com/patricklx/ember-tui/pull/56) improve render perf ([@patricklx](https://github.com/patricklx))
...
#### :bug: Bug Fix
* `ember-tui`
  * [#52](https://github.com/patricklx/ember-tui/pull/52) keep scrollBufferSize in state ([@patricklx](https://github.com/patricklx))
...
#### :bug: Bug Fix
* `ember-tui`
  * [#43](https://github.com/patricklx/ember-tui/pull/43) do not normalize all whitespace ([@patricklx](https://github.com/patricklx))
...
* ember-tui 0.2.10 (patch)

#### :bug: Bug Fix
* `ember-tui`
  * [#41](https://github.com/patricklx/ember-tui/pull/41) rename to keydown ([@patricklx](https://github.com/patricklx))
